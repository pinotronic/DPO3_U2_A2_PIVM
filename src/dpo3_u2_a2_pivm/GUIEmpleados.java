...
public class GUIEmpleados extends JFrame implements ActionListener {
    ...
    javax.swing.JTextField TXTId, TXTNombre, TXTDomicilio, TXTColonia, TXTCiudad, TXTCelular, TXTEmail, TXTSueldo, TXTContraseña, TXTAcomodador;
    ...
    private void initComponente() {
        ...
        TXTAcomodador.setBounds(200, 260, 180, 20);

        BTNAvanzar.setBounds(80, 350, 50, 30);
        BTNRegresar.setBounds(140, 350, 50, 30);
        ...
        PanelEmpleados.add(TXTAcomodador);
        ...
        BTNAvanzar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                ...
                TXTAcomodador.setText(modelo[9]);
                jcb2.addItem(modelo[9]);
